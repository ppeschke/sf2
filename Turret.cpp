...
Turret::Turret(unsigned int index, Player* o, renderableType i, Base* follow, Vec2D loc, Vec2D dir, float Rof, bool collides, bool draw) : Weapon(index, o, follow, loc, dir, Rof, collides, draw)
{
